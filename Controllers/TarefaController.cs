...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        public IActionResult ObterTodos()
        {
            ...
            var tarefas = _context.Tarefas.ToList(); // Buscar todas as tarefas no banco
        ...
        public IActionResult Criar(Tarefa tarefa)
        {
            ...
            _context.Tarefas.Add(tarefa); // Adicionar a tarefa ao contexto
        ...
        public IActionResult Atualizar(int id, Tarefa tarefa)
        {
            ...
            _context.Entry(tarefaBanco).State = EntityState.Modified; // Marcar a entidade como modificada
            _context.SaveChanges(); // Salvar as mudanças no banco
        ...
        public IActionResult Deletar(int id)
        {
            ...
            _context.Tarefas.Remove(tarefaBanco); // Remover a tarefa encontrada através do EF
            _context.SaveChanges(); // Salvar as mudanças no banco
